...
/** Intermediate table between Profiles and Users tables */
...
export const GetAllUsersLocalDocument = gql`
...
/**
 * __useGetAllUsersLocalQuery__
 *
 * To run a query within a React component, call `useGetAllUsersLocalQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllUsersLocalQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllUsersLocalQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAllUsersLocalQuery(baseOptions?: Apollo.QueryHookOptions<GetAllUsersLocalQuery, GetAllUsersLocalQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllUsersLocalQuery, GetAllUsersLocalQueryVariables>(GetAllUsersLocalDocument, options);
      }
export function useGetAllUsersLocalLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllUsersLocalQuery, GetAllUsersLocalQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllUsersLocalQuery, GetAllUsersLocalQueryVariables>(GetAllUsersLocalDocument, options);
        }
export type GetAllUsersLocalQueryHookResult = ReturnType<typeof useGetAllUsersLocalQuery>;
export type GetAllUsersLocalLazyQueryHookResult = ReturnType<typeof useGetAllUsersLocalLazyQuery>;
export type GetAllUsersLocalQueryResult = Apollo.QueryResult<GetAllUsersLocalQuery, GetAllUsersLocalQueryVariables>;
